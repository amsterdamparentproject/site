...
const ProgramHighlightBox = ({ icon, title, description }: HighlightProps) => {
  return (
    <div className="p-6 rounded-2xl border border-brand-soft-green bg-brand-white shadow-sm transition-all hover:shadow-md h-full">
      <div className="flex flex-row md:flex-col items-center md:items-start gap-4 mb-4">
        ...
        <h3 className="font-bold text-lg md:text-xl text-brand-charcoal leading-tight">
          {title}
        </h3>
      </div>

      <p className="text-sm leading-relaxed text-brand-soft-charcoal/80">
        {description}
      </p>
    </div>
  );
