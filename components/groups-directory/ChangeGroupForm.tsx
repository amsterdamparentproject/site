...
const ChangeGroupForm = ({
  ...
  const submitButtonStyle =
    `bg-brand-soft-green text-white text-lg mt-2 px-6 py-2 rounded transition-all cursor-pointer hover:brightness-105 disabled:opacity-50 disabled:cursor-not-allowed ` +
    focusStyle;
