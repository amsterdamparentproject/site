...
export const metadata = genPageMetadata({
  ...
  description:
    "Your nonprofit postpartum support system in Amsterdam. Expert-led discussions and local socials to help you transition to newborn parenthood with confidence.",
  openGraph: {
    images: [
