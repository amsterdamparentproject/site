    ...
    <div className="flex-column justify-center">
      <div className="flex flex-col items-center space-y-2 pt-6 md:space-y-5">
        ...
        <p className="mt-4 mb-4">
          <b>
            Welcome to the Spring 2025 cohort of APP's Burnout Support
            Program!{" "}
          </b>
          We're very grateful that you're joining us and that we're on this
          learning and healing journey together. There are 8 total members of
          the Spring 2025 cohort, all based in Amsterdam.
        </p>
        <p>
        ...
        <ul className="list-disc mx-4">
          <li>
            <b>1 April</b>: Program kickoff and 1:1 introductions
          </li>
          <li>
          ...
          <li>
            <b>10 May</b>: Cohort meetup #2 (in person)
          </li>
          <li>
            <b>11 May</b>: Discussion topic #4
          </li>
          <li>
            <b>25 May</b>: Discussion topic #5
          </li>
          <li>
            <b>31 May</b>: Cohort meetup #3 and program close (online)
          </li>
        </ul>
        <p>We'll send Google Calendar invites to help you stay up to date.</p>
        <p className="italic max-w-lg mb-12">
          Note: The program has no scheduled activities during upcoming Dutch
          holidays (Easter, King's Day, Ascension Day).
        </p>
        <ShowcaseButton
